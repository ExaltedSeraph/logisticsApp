...
jQuery(document).ready(function () {
    ...
    jQuery(".btn-open-map").on( "click", function() {
        ...
        switch (iteration) {
            case 1:
                jQuery(this).parent().parent().parent().parent().find(".dtl_gmap").animate({height:300},300);
                jQuery(this).parent().parent().parent().parent().find(".dtl_gmap").css("margin", "30px 0 0 0");
                jQuery(this).find(".url").html("Close Map");
                jQuery(this).addClass('click');
                break;

            case 2:
                jQuery(this).parent().parent().parent().parent().find(".dtl_gmap").animate({height:0},300);
                jQuery(this).parent().parent().parent().parent().find(".dtl_gmap").animate({margin:0},300);
